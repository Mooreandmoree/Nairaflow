...
const Footer = () => {
  ...
  return (
    <footer className="relative z-10 border-t border-neon/10 bg-dark/80 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm mb-4">
              Secure, fast, and reliable money transfers across Africa.
            </p>
            {/* Social Links */}
            <div className="flex space-x-4">
              {['twitter', 'linkedin', 'github', 'instagram'].map((social) => (
                <a
                  key={social}
                  href={`https://${social}.com/nairaflow`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-lg bg-dark-300 flex items-center justify-center
                           text-gray-400 hover:text-neon hover:bg-dark-200 transition-all"
                >
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 py-8 border-t border-gray-800">
          <SecurityBadge icon="🔒" text="256-bit SSL" />
          <SecurityBadge icon="🛡️" text="PCI DSS Compliant" />
          <SecurityBadge icon="✓" text="CBN Licensed" />
          <SecurityBadge icon="🔐" text="2FA Protected" />
        </div>

        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-gray-800">
          <p className="text-gray-500 text-sm">
            © {currentYear} NairaFlow. All rights reserved.
          </p>
